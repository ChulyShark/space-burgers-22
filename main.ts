...
sprites.onOverlap(SpriteKind.Player, SpriteKind.POWERUP, function (sprite, otherSprite) {
    Navesamigas = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . . . . . . . 
        ...
        . . . . . d f . . . . . . . . . 
        `, SpriteKind.MODE)
    Navesamigas.setPosition(10, 15)
    Navesamigas.lifespan = 15000
})
info.onScore(750, function () {
    story.printCharacterText("Llegaste a la tierra!", "Earth Reached!")
...
info.onScore(575, function () {
    story.printCharacterText("Alerta diabetica! Viene una dona!", "My goodness me!")
    dona = sprites.create(img`
        ..............bbbbbbb...........
        ...........bb66663333baa........
        .........bb3367776333663aa......
    ...
    statusbar.attachToSprite(dona)
    dona.setPosition(randint(0, scene.screenWidth()), 0)
    dona.follow(Spaceship, 35)
    BadBurger.follow(Spaceship, 45)
})
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    projectile = sprites.createProjectileFromSprite(img`
        ...
        2 
        `, Spaceship, 0, -100)
    if (Navesamigas && Navesamigas.x > 0) {
        projectile.y += -5
        projectile = sprites.createProjectileFromSprite(img`
            . . . . . . . . . . . . . . . . 
            . . . . . 3 3 3 3 3 3 3 . . . 3 
...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (info.score() >= 366) {
        ...
        projectile2 = sprites.createProjectileFromSprite(img`
            ...
            . . . . d d f f f f d d . . . . 
            . . . d d f 5 5 5 5 f d d . . . 
            . . . d d f 5 7 7 5 f d d . 5 . 
            7 . . d d f 5 5 5 5 f d d . . . 
            . . . d d d f f f f d d d . . . 
            . . . d d d d d d d d d d . 7 . 
            . 5 . . d d d d d d d d . . . . 
            . . . d f f f f f f f f d . . 5 
            . . d f d . . . . . . d f d . . 
            . d f d . . . . . . . . d f d . 
            . f d . . . . . . . . . . d f . 
...
function enemyDeath (enemy: Sprite) {
    ...
    if (Math.percentChance(3)) {
        powerup = sprites.create(img`
            ...
            . . . . f f f f f f f . . . . . 
            . . . f 9 9 9 9 9 9 9 f . . . . 
            . . f 9 9 9 9 5 9 9 9 9 f . . . 
            . f 9 9 9 9 9 d 9 9 9 9 9 f . . 
            . f 9 9 f 9 d 7 d 9 f 9 9 f . . 
            . f 9 9 f d d d d d f 9 9 f . . 
            . f 9 d d d d d d d d d 9 f . . 
            . f 9 9 9 9 9 7 9 9 9 9 9 f . . 
            . f 9 9 9 9 9 d 9 9 9 9 9 f . . 
            . f 9 9 9 9 d d d 9 9 9 9 f . . 
...
info.onScore(1, function () {
    canciontakeonme = music.convertRTTTLToMelody("Mission:d=4,o=6,b=100:32d,32d#,32d,32d#,32d,32d#,32d,32d#,32d,32d,32d#,32e,32f,32f#,32g,16g,8p,16g,8p,16a#,16p,16c,16p,16g,8p,16g,8p,16f,16p,16f#,16p,16g,8p,16g,8p,16a#,16p,16c,16p,16g,8p,16g,8p,16f,16p,16f#,16p,16a#,16g,2d,32p,16a#,16g,2c#,32p,16a#,16g,2c,16p,16a#5,16c")
    music.play(music.stringPlayable(canciontakeonme, 180), music.PlaybackMode.LoopingInBackground)
})
...
info.onScore(150, function () {
    story.printCharacterText("WARNING! Se acerca el TACO LOCO!!!", "De terror!")
    tacoloco = sprites.create(img`
        ..............eeeeeee...........
        ............ee455662e2e.........
        ..........ee45556723e2688.......
        .........e46776677232e777668....
        ........e46745554772227776778...
        .......44487444f4777766777678...
        ......45ffe777ff767f77666ff668..
        .....4523ff776f722e6ffeeffe888..
        ....455232effff2322e4ffffddd48..
        ...4456777755f623e455dffdddddd4.
        ...e667745522222455dd2225554dd44
        ..e46777442222222dd52222255dddd4
        ..e56686776222222555222225555dde
        .e45544e8772222255554222255555de
        .e554eeee66e522255d55522dddd54de
        .e55ee44fee5d52555555d5d5dddddde
        e454eeeefe45d55555555555dd4ddde.
        e5e4eefffe5d55555555d5555dddde..
        e5ee4eeff45d515555555155dddde...
        e5eeeeffe511111151111115ddde....
        e5ffefeee51111111111111dd4e.....
        e5ffffffe14111111111111dee......
        e54efeff4111111122222dde........
        e5eeeffe5111111122222ee.........
        e4eeefff5d55111122222...........
        e4efefff5d5d555522222...........
        .e4efffe5d55555522222...........
        .e54eeee5d545dd4e2222...........
        ..e554ee5dddddee..222...........
        ...ee5544dddee..................
        .....eeeeeee....................
        ................................
        `, SpriteKind.Jefe)
    statusbar = statusbars.create(20, 4, StatusBarKind.EnemyHealth)
    statusbar.attachToSprite(tacoloco)
    tacoloco.setPosition(randint(0, scene.screenWidth()), 0)
    tacoloco.follow(Spaceship, 35)
    BadBurger.follow(Spaceship, 33)
})
info.onLifeZero(function () {
    music.stopAllSounds()
    game.setGameOverMessage(false, "Intentalo de nuevo!")
    game.gameOver(false)
...
info.onScore(366, function () {
    story.printText("nuke ready! Aprieta B cada 6 segundos!", 30, 30)
})
let badpizza: Sprite = null
let tacoloco: Sprite = null
let canciontakeonme = ""
let powerup: Sprite = null
let projectile2: Sprite = null
let projectile: Sprite = null
let BadBurger: Sprite = null
let statusbar: StatusBarSprite = null
let dona: Sprite = null
let Navesamigas: Sprite = null
...
scene.setBackgroundImage(img`
    ...
    3333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333
    `)
music.play(music.createSong(hex``), music.PlaybackMode.InBackground)
pause(1000)
game.setDialogTextColor(15)
game.showLongText("Space Burgers \n Por Sebastián Mendoza", DialogLayout.Bottom)
game.showLongText("Copyright \\n Sebas Productions", DialogLayout.Bottom)
game.splash("Destruye esas Hamburguesas!")
effects.starField.startScreenEffect()
Spaceship = sprites.create(img`
    ...
    . . . . . . 5 . 5 . . . . . . . 
    `, SpriteKind.Player)
Spaceship.setPosition(77, 99)
controller.moveSprite(Spaceship)
Spaceship.setStayInScreen(true)
info.setLife(5)
game.onUpdate(function () {
    if (info.score() == 1000) {
        if (game.ask("Deseas seguir jugando?", "BOTON B Para terminar!")) {
            game.splash("Listo! a seguir jugando!")
            scene.setBackgroundImage(img`
                
            ...
            music.play(music.melodyPlayable(music.magicWand), music.PlaybackMode.UntilDone)
            game.setGameOverMessage(true, "Gracias por jugar mi Juego!")
            game.gameOver(true)
        }
    }
})
game.onUpdateInterval(450, function () {
    BadBurger = sprites.create(img`
        . . . . c c c b b b b b . . . . 
        ...
        . . . c c c c c e e e e e . . . 
        `, SpriteKind.Enemy)
    BadBurger.setPosition(randint(0, scene.screenWidth()), 0)
    BadBurger.follow(Spaceship, 25)
    if (info.score() == 110) {
        BadBurger.follow(Spaceship, 40)
    }
    if (info.score() >= 750) {
        badpizza = sprites.create(img`
            . . . . . . b b b b . . . . . . 
            . . . . . . b 4 4 4 b . . . . . 
            . . . . . . b b 4 4 4 b . . . . 
            . . . . . b 4 b b b 4 4 b . . . 
            ...
            4 4 4 4 . . . . . . . . . . . . 
            `, SpriteKind.Enemy)
        badpizza.setPosition(randint(0, scene.screenWidth()), 0)
        badpizza.follow(Spaceship, 35)
    }
})
